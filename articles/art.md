...
> AI Art — 视觉艺术、音乐生成、文学创作、版权与原创

## 分类框架

| 子方向 | 关键词 |
|--------|--------|
| 🎨 视觉艺术 | AI 绘画、图像生成、风格迁移 |
...
#### 📄 1. MuSS: 首个大规模多镜头视频生成数据集与电影叙事基准

| 字段 | 内容 |
|------|------|
| **标题** | 打破垄断！华南理工等团队发布首个大规模多镜头视频生成数据集，推动视频生成迈向工业级应用 |
| **来源** | 机智流 (微信公众号) |
| **日期** | 2026-05-09 |
...
#### 📄 10. 文字到视听：AI视频生成的认知逻辑架构

| 字段 | 内容 |
|------|------|
| **标题** | 文字到视听：AI视频生成的认知逻辑架构 |
| **来源** | 原创分析 |
| **日期** | 2026-05-17 |
| **模块** | 🎨 视觉艺术 → AI视频生成 / 理论基础 |
...
*本文档持续更新。建议通过 CNKI、arXiv、Google Scholar 等平台检索最新文献。*
*收录标准：具有学术深度或行业影响力的 AI 艺术相关文章、论文、评论。*
